...
import { CustomSummaryAgent, isCustomSummarySelected, isCustomSummaryAvailable } from './worker/CustomSummaryAgent.js';
...
export class WorkerService {
  ...
  private customSummaryAgent: CustomSummaryAgent;
  ...
  constructor() {
    ...
    this.customSummaryAgent = new CustomSummaryAgent(this.dbManager, this.sessionManager);
    ...
    this.server = new Server({
      ...
      getAiStatus: () => {
        let provider = 'claude';
        if (isCustomSummarySelected() && isCustomSummaryAvailable()) provider = 'custom';
  ...
  private registerRoutes(): void {
    ...
    this.server.registerRoutes(new SessionRoutes(this.sessionManager, this.dbManager, this.sdkAgent, this.geminiAgent, this.openRouterAgent, this.customSummaryAgent, this.sessionEventBroadcaster, this));
